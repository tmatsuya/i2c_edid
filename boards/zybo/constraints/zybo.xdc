...
create_clock -add -name clk_125_pin -period 8.00 -waveform {0 4} [get_ports clk_125]

##Switches
##IO_L19N_T3_VREF_35
set_property PACKAGE_PIN G15 [get_ports {dipsw[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dipsw[0]}]

##IO_L24P_T3_34
set_property PACKAGE_PIN P15 [get_ports {dipsw[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dipsw[1]}]

##IO_L4N_T0_34
set_property PACKAGE_PIN W13 [get_ports {dipsw[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {dipsw[2]}]

##IO_L9P_T1_DQS_34
set_property PACKAGE_PIN T16 [get_ports {dipsw[3]}]
...
#set_property PACKAGE_PIN MIO50 [get_ports {btn[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[4]}]

#set_property PACKAGE_PIN MIO51 [get_ports {btn[5]}]
